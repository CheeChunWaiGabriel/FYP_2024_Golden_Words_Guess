...
public class Puzzlecode_Normal_Chinese_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.puzzle_layout_normal_chinese_3);
        ...
        View.OnClickListener letterClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (currentBoxIndex < boxes.length) {
                    ...
                    button.setTextColor(ContextCompat.getColor(Puzzlecode_Normal_Chinese_3.this, R.color.grey));
