...
public class Puzzlecode_Easy_English_3 extends AppCompatActivity {

    private TextView[] boxes;
    private int currentBoxIndex = 0;
    private final String correctWord = "FROG";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.puzzle_layout_easy_english_3);
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Puzzlecode_Easy_English_3.this, MainActivity.class);
