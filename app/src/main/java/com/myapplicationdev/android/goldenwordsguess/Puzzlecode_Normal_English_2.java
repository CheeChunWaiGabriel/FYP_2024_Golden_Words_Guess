...
public class Puzzlecode_Normal_English_2 extends AppCompatActivity {

    private TextView[] boxes;
    private Button[] letterButtons;
    private int currentBoxIndex = 0;
    private final String correctWord = "WATER";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.puzzle_layout_normal_english_2);
    ...
    private void setControlButtonListeners() {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Puzzlecode_Normal_English_2.this, NormalActivity.class));
                buttonClick.start();
            }
        });
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Puzzlecode_Normal_English_2.this, Puzzlecode_Normal_English_3.class));
                buttonClick.start();
            }
        });
    }
