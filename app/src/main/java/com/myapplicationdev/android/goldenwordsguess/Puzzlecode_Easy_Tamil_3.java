...
public class Puzzlecode_Easy_Tamil_3 extends AppCompatActivity {

    private TextView[] boxes;
    private int currentBoxIndex = 0;
    private final String correctWord = "மகிழ்ச்சி";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Puzzlecode_Easy_Tamil_3.this, MainActivity.class);
