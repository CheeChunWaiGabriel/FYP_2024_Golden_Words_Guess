...
public class Puzzlecode_Expert_Chinese_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.puzzle_layout_expert_chinese_2);
        ...
        View.OnClickListener letterClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (currentBoxIndex < boxes.length) {
                    ...
                    button.setTextColor(ContextCompat.getColor(Puzzlecode_Expert_Chinese_2.this, R.color.grey));
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Puzzlecode_Expert_Chinese_2.this, ExpertActivity.class);
