...
public class Puzzlecode_Easy_Chinese_2 extends AppCompatActivity {

    private TextView[] boxes;
    private Button[] letterButtons;
    private int currentBoxIndex = 0;
    private final String correctWord = "万事如意";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.puzzle_layout_easy_chinese_2);
    ...
    private void setControlButtonListeners() {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Puzzlecode_Easy_Chinese_2.this, EasyActivity.class));
                buttonClick.start();
            }
        });
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Puzzlecode_Easy_Chinese_2.this, Puzzlecode_Easy_Chinese_3.class));
                buttonClick.start();
            }
        });
    }
