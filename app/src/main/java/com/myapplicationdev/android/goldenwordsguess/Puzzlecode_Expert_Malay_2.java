...
public class Puzzlecode_Expert_Malay_2 extends AppCompatActivity {

    private TextView[] boxes;
    private Button[] buttons;
    private int currentBoxIndex = 0;
    private final String correctWord = "DAGING";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.puzzle_layout_expert_malay_2);
        ...
        Button btnTop1 = findViewById(R.id.btn_letter_top1);
        ...
        buttons = new Button[]{
                btnTop1, btnTop2, btnLeft1, btnRight1, btnLeft2, btnRight2
        };
        ...
        View.OnClickListener letterClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (currentBoxIndex < boxes.length) {
                    ...
                    button.setTextColor(ContextCompat.getColor(Puzzlecode_Expert_Malay_2.this, R.color.grey));
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Puzzlecode_Expert_Malay_2.this, ExpertActivity.class);
