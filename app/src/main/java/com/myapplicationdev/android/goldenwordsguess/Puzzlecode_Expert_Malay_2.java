...
public class Puzzlecode_Expert_Malay_2 extends AppCompatActivity {
    ...
    private final String correctWord = "GADING";
    ...
    private void setControlButtonListeners() {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Puzzlecode_Expert_Malay_2.this, ExpertActivity.class));
                buttonClick.start();
            }
        });
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Puzzlecode_Expert_Malay_2.this, Puzzlecode_Expert_Malay_3.class));
                buttonClick.start();
            }
        });
    }
