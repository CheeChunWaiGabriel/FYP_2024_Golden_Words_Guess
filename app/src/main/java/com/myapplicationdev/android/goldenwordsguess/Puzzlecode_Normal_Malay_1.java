...
public class Puzzlecode_Normal_Malay_1 extends AppCompatActivity {

    private TextView[] boxes;
    private Button[] buttons;
    private int currentBoxIndex = 0;
    private final String correctWord = "MAKAN";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.puzzle_layout_normal_malay_1);
        ...
        View.OnClickListener letterClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (currentBoxIndex < boxes.length) {
                    ...
                    button.setTextColor(ContextCompat.getColor(Puzzlecode_Normal_Malay_1.this, R.color.grey));
