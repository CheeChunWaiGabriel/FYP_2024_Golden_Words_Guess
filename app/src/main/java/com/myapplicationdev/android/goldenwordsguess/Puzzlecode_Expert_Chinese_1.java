...
public class Puzzlecode_Expert_Chinese_1 extends AppCompatActivity {
    ...
    private void setControlButtonListeners() {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Puzzlecode_Expert_Chinese_1.this, ExpertActivity.class));
                buttonClick.start();
            }
        });
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Puzzlecode_Expert_Chinese_1.this, Puzzlecode_Expert_Chinese_2.class));
                buttonClick.start();
            }
        });
    }
