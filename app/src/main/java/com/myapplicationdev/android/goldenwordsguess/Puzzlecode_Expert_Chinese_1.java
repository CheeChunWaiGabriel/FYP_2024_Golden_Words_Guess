...
public class Puzzlecode_Expert_Chinese_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener letterClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (currentBoxIndex < boxes.length) {
                    ...
                    button.setTextColor(ContextCompat.getColor(Puzzlecode_Expert_Chinese_1.this, R.color.grey));
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Puzzlecode_Expert_Chinese_1.this, ExpertActivity.class);
