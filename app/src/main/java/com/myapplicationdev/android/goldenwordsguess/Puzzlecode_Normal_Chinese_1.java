...
public class Puzzlecode_Normal_Chinese_1 extends AppCompatActivity {
    ...
    private void setControlButtonListeners() {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Puzzlecode_Normal_Chinese_1.this, NormalActivity.class));
                buttonClick.start();
            }
        });
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Puzzlecode_Normal_Chinese_1.this, Puzzlecode_Normal_Chinese_2.class));
                buttonClick.start();
            }
        });
    }
